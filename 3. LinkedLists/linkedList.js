...
class MySinglyLinkedList {
    ...
    append(value) {
        ...
        // this.tail.next => Le estamos pasando al next del this.head.next debido a la referencia en memoria, el nodo que es un obj para que deje de ser null y enlazarlo
        // head = 1 -> 2 -> 3 -> null
        // tail = 3 -> "new" -> null
